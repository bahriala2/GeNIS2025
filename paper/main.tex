...
\todo{Report our recomputed per-interval statistics table here (Table 1
from the notebook run). Note and resolve the discrepancy with the
descriptor's Table 12 (e.g.\ benign-background: 10,286 reported vs.\ 8,283
loaded at 60\,s) --- recount from the released files and state which
figures this paper uses.}
